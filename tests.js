...
$('.menu.fl-l').find('a.fl-l').each(function(ind,el){

if ($(this)[0].innerText == 'Обучалка') {
    $(this).attr('onClick','educationScriptStart()');
}
